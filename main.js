...
sketch=document.getElementById("draw")=aircraft_carrier=quick_draw_data_set[random_number];
...
function draw(){
    check_sketch(){
        ...
        timer_counter=0+1
        document.getElementById("real_time").innerHTML=timer_counter;
        if(timer_counter>400){
        document.getElementById("real_time").innerHTML="Times Up!";
